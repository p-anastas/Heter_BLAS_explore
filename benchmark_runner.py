							...
							for N_layout in layouts:
								for K_layout in layouts:
									for addmode in addmodes:
										...
										CPU_only = Runner + ' 0 0 0 BENCHMARK >>Results/CPU_only_log_' + machine + '.md 2>Results/CPU_only_error_' + machine + '.md'
										GPU_only = Runner + ' ' + str(M) + ' 0 0 BENCHMARK >>Results/GPU_only_log_' + machine + '.md 2>Results/GPU_only_error_' + machine + '.md'
